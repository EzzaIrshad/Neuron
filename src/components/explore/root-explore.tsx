    ...
    return (
        <div id='explore' className=' w-full flex flex-col items-center gap-18 mt-43'>
            <div className='flex flex-col gap-x-4 w-[clamp(100px,50vw,590px)]'>
                ...
                <h2 className="text-[#121211] text-center text-[clamp(1.8rem,5vw,2.5rem)] font-semibold mt-4">Your files and photos, safe and accessible</h2>
                <p className='text-center text-[#121211] mt-6'>Securely save, share, and access your files and photos wherever you are.</p>
            </div>

            <div className='relative'>
                <Image src="/images/explore_img.png" alt="explore" width={1000} height={562} className='h-auto' />
                <div className='absolute -top-35 sm:-top-50 -left-20 sm:-left-90 -z-10 w-[60vw] h-[50vh] sm:h-[70vh]'>
                    <svg className='w-full h-full' viewBox="0 0 1211 1483" fill="none" xmlns="http://www.w3.org/2000/svg">
